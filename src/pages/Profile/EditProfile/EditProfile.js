...
//     }
//     if (editedInfo){
//       await axios.patch(`https://twitterback-uuwq.onrender.com/userUpdates/${user?.email}`, editedInfo)
//     }
//     setOpen(false)
//   }
//   return (
...
//               <TextField className='text-field' fullWidth label='Name' is='fullWidth' variant='filled' onChange={(e) => setName
//               (e.target.value)} defaultValue={loggedInUser[0]?.name?loggedInUser[0]?.name:''} />
//               <TextField className='text-field' fullWidth label='Bio' is='fullWidth' variant='filled' onChange={(e) => setBio
//               (e.target.value)} defaultValue={loggedInUser[0]?.bio ? loggedInUser[0]?.bio : ''} />
//               <TextField className='text-field' fullWidth label='Location' is='fullWidth' variant='filled' onChange={(e) => setLocation
//               (e.target.value)} defaultValue={loggedInUser[0]?.location ? loggedInUser[0]?.location : ''} />
//               <TextField className='text-field' fullWidth label='Website' is='fullWidth' variant='filled' onChange={(e) => setWebsite
