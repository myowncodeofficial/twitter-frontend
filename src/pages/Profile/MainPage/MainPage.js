...
const MainPage = ({ user }) => {
    ...
    useEffect(() => {
        fetch(`https://twitterfullapplicationbackend.onrender.com/userPost?email=${user?.email}`)
        .then(res => res.json())
        .then(data => {
            setPosts(data)
        })
        ...
        setIsLoading(true);
            ...
            axios.post('https://api.imgbb.com/1/upload?key=6f902511a781fc19e6f532fc69739a85', formData)
                .then(res => {
                    ...
                    setIsLoading(false);
                    if (url) {
                        axios.patch(`https://twitterfullapplicationbackend.onrender.com/userUpdates/${user?.email}`, userCoverImage)
                    }
                })
    }
        ...
        setIsLoading(true);
            ...
            axios.post('https://api.imgbb.com/1/upload?key=6f902511a781fc19e6f532fc69739a85', formData)
                .then(res => {
                    ...
                    setIsLoading(false);
                    if (url) {
                        axios.patch(`https://twitterfullapplicationbackend.onrender.com/userUpdates/${user?.email}`, userProfileImage)
                    }
                })
    }
